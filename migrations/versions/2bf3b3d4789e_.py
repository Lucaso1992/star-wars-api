...
Revision ID: 2bf3b3d4789e
Revises: 5965b790febd
Create Date: 2023-07-20 10:25:46.287574
...
def upgrade():
    ...
    sa.Column('vehicle_fk', sa.Integer(), nullable=True),
    sa.Column('character_fk', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['character_fk'], ['character.id'], ),
    sa.ForeignKeyConstraint(['planet_fk'], ['planet.id'], ),
    sa.ForeignKeyConstraint(['user_fk'], ['user.id'], ),
    sa.ForeignKeyConstraint(['vehicle_fk'], ['vehicle.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
